export class ClippingsVolumeAacrTemplate {
    ...
    titleInfo: {
      ...
      fields: {
        title: {
          ...
          description: `Názvová informace – název výstřižku`
        },
        subTitle: {
          usage: 'MA',
          label: 'Podnázev',
          ...
          cols: 2,
          description: `Podnázev názvu výstřižku`
        },
      }
    },
    name: {
    ...
    originInfo: {
      ...
      fields: {
        publisher: {
          ...
          description: `Jméno entity, která dokument vydala`,
        },
        dateIssued: {
          usage: 'M',
          label: 'Datum vydání',
