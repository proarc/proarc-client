            ...
            Odpovídá hodnotám z katalogizačního záznamu, pole 260, $a resp. pole 008/15-17`,
              fields: {
                authority: {
                  usage: 'MA',
                  label: 'Autorita',
                  selector: 'relatedItem/originInfo/place/placeTerm/@authority',
                  labelKey: 'relatedItem/originInfo/place/placeTerm/@authority',
                  options: [
                    ['marccountry', 'marccountry']]
                },
                type: {
                  usage: 'MA',
                  label: 'Typ',
                  selector: 'relatedItem/originInfo/place/placeTerm/@type',
                  labelKey: 'relatedItem/originInfo/place/placeTerm/@type',
                  options: [
                    ['code', 'code'],
                    ['text', 'text']]
                },
      ...
      Pro monografie hodnota <strong>volume</strong>`,
          fields: {
            authority: {
              usage: 'MA',
              label: 'Autorita',
              selector: 'relatedItem/genre/@authority',
              labelKey: 'relatedItem/genre/@authority',
              options: [
                ['czenas', 'czenas'],
                ['eczenas', 'eczenas']]
            },
        ...
        part: {
          ...
          fields: {
            type: {
              ...
              labelKey: 'relatedItem/part/@type',
              description: `Hodnota bude vždy "volume" `,
              options: [
                ['volume', 'volume']
              ]
