export class NdkMonographSupplementAacrTemplate {
  ...
  static data = {
    ...
    originInfo: {
      ...
      selector: 'originInfo',
      labelKey: 'originInfo',
      description: `Informace o původu předlohy: odpovídá poli 260<br/>
      ...
      popsat tiskaře. Pokud je nutno vyjádřit tiskaře (pole 260 $a, $b, $c), je nutno element <originInfo>
    ...
    physicalDescription: {
      ...
      fields: {
        ...
        form: {
          ...
          Údaje o typu média a typu nosiče zdroje/předlohy odpovídá hodnotám z pole 008 MARC 21`,
          fields: {
            authority: {
              usage: 'MA',
              label: 'Autorita',
