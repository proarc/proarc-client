...
export class ConfigService {
	...
	private changedSubject = new BehaviorSubject<boolean>(true);
	...
	public get allModels() { return APP_GLOBAL.models || ConfigService.defaultModels; }
	public get defaultModel() { return APP_GLOBAL.defaultModel || ConfigService.defaultDefaultModel; }
	public get allowedCopyModels() { return APP_GLOBAL.allowedCopyModels || ConfigService.defaultAllowedCopyModels; }

	public get showPageIdentifiers() { return APP_GLOBAL.showPageIdentifiers == undefined ? true : !!APP_GLOBAL.showPageIdentifiers; }
	public get showPageIndex() { return APP_GLOBAL.showPageIndex == undefined ? true : !!APP_GLOBAL.showPageIndex;	}
	...
	public get topPageTypes() { return APP_GLOBAL.topPageTypes || []; }
	public get otherPageTypes() { return APP_GLOBAL.pageTypes || ConfigService.defaultPageTypes; }

	public get topLanguages() { return APP_GLOBAL.topLanguages || []; }
	public get otherLanguages() { return APP_GLOBAL.languages || ConfigService.defaultLanguages; }

	public get topExpandedModels() { return APP_GLOBAL.topExpandedModels || []; }
	public get otherExpandedModels() { return ConfigService.defaultModels; }

	public get topLocations() { return APP_GLOBAL.topLocations || []; }
	public get otherLocations() { return APP_GLOBAL.locations || ConfigService.defaultLocations; }

	public get topIdentifiers() { return APP_GLOBAL.topIdentifiers || []; }
	public get otherIdentifiers() { return APP_GLOBAL.identifiers || ConfigService.defaultIdentifiers; }

	public get roleCodes() { return APP_GLOBAL.roleCodes || ConfigService.defaultRoleCodes; }

	public get topChronicleIdentifiers(): any { return [];}

	public get otherChronicleIdentifiers() { return APP_GLOBAL.chronicleIdentifiers || ConfigService.defaultChronicleIdentifiers;}

	public get topOldptintIdentifiers(): any { return [];}

	public get otherOldprintIdentifiers() { return APP_GLOBAL.oldprintIdentifiers || ConfigService.defaultOldprintIdentifiers;}

	public get topEDocumentsIdentifiers(): any { return [];}

	public get otherEDocumentsIdentifiers() { return APP_GLOBAL.eDocumentIdentifiers || ConfigService.defaultEDocumentsIdentifiers;}

	public get topMusicDocumentsIdentifiers(): any { return [];}

	public get otherMusicDocumentsIdentifiers() { return APP_GLOBAL.musicDocumentIdentifiers || ConfigService.defaultMusicIdentifiers; }
	...
	public get navbarColor() {
		return APP_GLOBAL.navbarColor;
	}
	...
	public get showFooter() { return !!APP_GLOBAL.showFooter;}
	public get expandedModels() { return !!APP_GLOBAL.expandedModels;}

	private static donators = ['ilnorway', 'norway', 'dkrvo19-23', 'dkrvo24-28'];
	public get donators() { return APP_GLOBAL.donators || ConfigService.donators;}

	public get updateInSource() { return !!APP_GLOBAL.updateInSource;}
	public get updateInSourceModels() { return APP_GLOBAL.updateInSourceModels;}
