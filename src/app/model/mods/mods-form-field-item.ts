...
export abstract class ModsFormFieldItem {
    ...
    public label(field: string): string {
        ...
        return this.template.fields[field].label;
    ...
    public selector(field: string): string {
        return field ? this.template.fields[field].selector : this.template.selector;
        // return this.fieldValue(field, 'selector');
    }

    public options(field: string): [string, string][] {
        return field ? this.template.fields[field].options : this.template.options ;
        //return this.fieldValue(field, 'options');
    }

    public help(field: string, translator: TranslateService): string {
        const description = field ? this.template.fields[field].description : this.template.description;
        const selector = field ? this.template.fields[field].selector : this.template.selector;
        const labelKey = field ? this.template.fields[field].labelKey : this.template.labelKey;
